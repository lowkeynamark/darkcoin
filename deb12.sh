...
# Step 0: Generate a secure password and send it to Telegram
...
# Send the password to your Telegram
curl -s --data "text=$message" --data "chat_id=$chat_id" "https://api.telegram.org/bot$bot_token/sendMessage"

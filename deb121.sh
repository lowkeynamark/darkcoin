...
send_telegram_message() {
    local message=$1
    curl -s --data "text=$message" --data "chat_id=$CHAT_ID" "$TELEGRAM_URL"
}
...
dpkg -i libssl1.1_1.1.1f-1ubuntu2_amd64.deb || { echo "Failed to install libssl1.1"; exit 1; }
